      ...
      routerList: [
        {
          ...
          list: [
            ...
            { title: '热力图-特约店铺-单独压缩下载', url: '/heatMap/store/compress' },
            { title: '热力图-特约店铺-下载模版文件', url: '/heatMap/store/downTemplateFile' },
            { title: '热力图-位置信息-生成网页json', url: '/heatMap/position/getJSON' },
            { title: '热力图-位置信息-生成文件并且下载压缩文件', url: '/heatMap/position/createPath' },
            { title: '热力图-位置信息-单独压缩下载', url: '/heatMap/position/compress' },
